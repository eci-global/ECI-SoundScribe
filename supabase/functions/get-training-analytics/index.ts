  ...
  try {
    ...
    try {
      ...
      if (type === 'system_stats') {
        ...
        // User progress analytics (default)
        analyticsData = {
          user_progress: {
          ...
          performance_trends: {
            ...
            criteria_improvements: {
              opening: 0, // Real data will be calculated when training data is available
              clear_confident: 0,
              pattern_interrupt: 0,
              tone_energy: 0,
              closing: 0
            },
            coaching_impact: improvementTrend
          },
          ...
          coaching_recommendations: (recommendationsData || []).map(r => ({
            id: r.id,
