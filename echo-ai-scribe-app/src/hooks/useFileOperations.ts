      ...
      try {
        ...
        if (response.ok) {
          ...
          if (workerResult.success || !workerResult.error) {
            ...
            console.log('Backend response:', workerResult);
            
            // Success - continue to completion flow outside this try-catch
          } else {
        ...
        // If we get here, Azure backend succeeded - continue to success flow
